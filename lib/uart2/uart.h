...
/* Set size of receive and transmit buffers */
	...
	#define UART_TX2_BUFFER_SIZE 64 /**< Size of the circular transmit buffer, must be power of 2 */
#endif
#ifndef UART_TX3_BUFFER_SIZE
	#define UART_TX3_BUFFER_SIZE 64 /**< Size of the circular transmit buffer, must be power of 2 */
#endif
